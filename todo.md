...
## СУБД:
- Установить drizzle + drizzle-kit
- описать конфигурацию в drizzle.config.ts
- добавить переменную в env для подключения к db по url 
- описать модели данных и добавить их в схему
- создать тестовое окружение для интеграционных тестов БД 
